describe('Definir una palabra con base al documento usando el chatbot', () => {
  ...
  it('Realiza una pregunta en el chat', () => {
    ...
    cy.get('[data-cy="chatbot-input"]').type('De acuerdo al documento, ¿qué es el cambio climático?')
