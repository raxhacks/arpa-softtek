        ...
        <div className='grid grid-cols-3 p-4 lg:pt-16 lg:pb-6 z-20 fixed pt-10 pb-4 w-full items-center justify-around bg-background-500 ml-10'>
            ...
            <div className='flex justify-center items-start mt-28 p-4 lg:p-20 z-0'>
                ...
                {sortedDocs.filter((item) => {
                    ...
                    <Fade >
                      <button className='w-72 lg:w-96 rounded-2xl p-4 bg-favsnhistory-500 transition-colors shadow-md hover:border-blue-200' onClick={() => handleClick(item.id, item.analysis_id)}>
                        <div className='flex flex-col justify-between'>
                          <button className='flex self-end z-30 rounded-full hover:bg-black p-1 transition-shadow'>
                            ...
                          </button>
