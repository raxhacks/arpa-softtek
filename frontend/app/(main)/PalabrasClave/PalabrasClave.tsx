    ...
    if(data.tab === "Palabras clave del autor"){
        return(
            <div className="flex flex-col md:flex-row justify-center items-center mt-[2vh] h-auto md:h-[60vh]">
                ...
                {loading ? 
                    <button className="h-[8vh] w-[12vw] self-center justify-self-center border-[5px] border-[#FCFAF5] text-[#FCFAF5] rounded-[10px] bg-transparent ml-0
                        md:ml-[4vw] text-[3vh] mt-[5vh] md:mt-0 min-w-[150px] hover:bg-[#FCFAF5] hover:text-[#24252E] flex items-center justify-center">
