        ...
        <div className="sectionGroup">
          <div className="sections">
            <div className="flex flex-row items-center">
              ...
              {/* Boton 4  */}
              <Link className="mr-4 lg:mr-10" href={`/History`}>
                <svg xmlns="http://www.w3.org/2000/svg" className="icon-tabler icon-tabler-logout-2" width="44" height="44" viewBox="0 0 24 24" stroke-width="1.5" stroke="#FCFAF5" fill="none" stroke-linecap="round" stroke-linejoin="round">
                  <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
